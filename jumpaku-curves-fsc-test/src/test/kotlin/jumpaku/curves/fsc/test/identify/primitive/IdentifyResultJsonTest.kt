...
import jumpaku.curves.fsc.identify.primitive.IdentifyResultJson
...
class IdentifyResultJsonTest{
    ...
    @Test
    fun testIdentifyResultJson() {
        println("IdentifyResultJson")
        val a = IdentifyResultJson.toJsonStr(r).parseJson().let { IdentifyResultJson.fromJson(it) }
        Assert.assertThat(a, Matchers.`is`(closeTo(r)))
    }
}