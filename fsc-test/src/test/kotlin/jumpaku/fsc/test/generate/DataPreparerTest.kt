...
import jumpaku.core.test.affine.shouldBeParamPoint
...
class DataPreparerTest {
    ...
    fun testFill() {
        ...
        a.size().shouldBe(9)
        a[0].shouldBeParamPoint(ParamPoint(Point.xy(1.0, -2.0), 10.0))
        a[1].shouldBeParamPoint(ParamPoint(Point.xy(1 + 0.5 / 3.0, -2 - 1 / 3.0), 10 + 5 / 3.0))
        a[2].shouldBeParamPoint(ParamPoint(Point.xy(1 + 1 / 3.0, -2 - 2 / 3.0), 10 + 10 / 3.0))
        a[3].shouldBeParamPoint(ParamPoint(Point.xy(1.5, -3.0), 15.0))
        a[4].shouldBeParamPoint(ParamPoint(Point.xy(1.7, -3.4), 17.0))
        a[5].shouldBeParamPoint(ParamPoint(Point.xy(1.9, -3.8), 19.0))
        a[6].shouldBeParamPoint(ParamPoint(Point.xy(2.1, -4.2), 21.0))
        a[7].shouldBeParamPoint(ParamPoint(Point.xy(2.3, -4.6), 23.0))
        a[8].shouldBeParamPoint(ParamPoint(Point.xy(2.5, -5.0), 25.0))
    }
    ...
    fun testExtendFront() {
        ...
        subdivided._1().get().shouldBeBSpline(b.subdivide(2.0)._1().get(), 0.2)
        subdivided._2().get().shouldBeBSpline(b.subdivide(2.0)._2().get(), 0.01)
    }
    ...
    fun testExtendBack() {
        ...
        subdivided._1().get().shouldBeBSpline(b.subdivide(1.0)._1().get(), 0.01)
        subdivided._2().get().shouldBeBSpline(b.subdivide(1.0)._2().get(), 0.2)
    }
}