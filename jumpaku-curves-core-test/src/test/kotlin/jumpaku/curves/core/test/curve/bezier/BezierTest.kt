...
class BezierTest {
    ...
    fun testDifferentiate() {
        ...
        assertThat(
            d.curve,
            `is`(closeTo(Bezier(Point.xy(4.0, 0.0), Point.xy(4.0, 8.0), Point.xy(4.0, -8.0), Point.xy(4.0, 0.0))))
        )
    ...
    fun testSimilarityTransform() {
        ...
        val e = Bezier(
            ...
            Point.xyr(-3.0, 1.0, 0.0),
            Point.xyr(1.0, 3.0, 4.0),
            Point.xyr(1.0, 5.0, 2.0)
        )
        assertThat(a, `is`(closeTo(e)))
    }
    ...
    fun testClipout() {
        println("Clipout")
        assertThat(
            bc.clipout(0.25, 0.5), `is`(
                closeTo(
                    Bezier(
                        Point.xyr(-1.0, 27 / 64.0, 161 / 128.0),
                        Point.xyr(-3 / 4.0, 9 / 16.0, 39 / 32.0),
                        Point.xyr(-1 / 2.0, 11 / 16.0, 37 / 32.0),
                        Point.xyr(-1 / 4.0, 3 / 4.0, 9 / 8.0),
                        Point.xyr(0.0, 3 / 4.0, 9 / 8.0)
                    )
                )
            )
        )
    ...
    fun testElevate() {
        ...
        val expected =
            Bezier(Point.xr(-1.0, 0.0), Point.xr(-1 / 3.0, 4 / 3.0), Point.xr(1 / 3.0, 4 / 3.0), Point.xr(1.0, 0.0))
    ...
    fun testReduce() {
        ...
        val b4 = Bezier(
            Point.xyr(-1.0, 0.0, 0.0),
            Point.xyr(-0.5, 1.0, 1.0),
            Point.xyr(0.0, 4 / 3.0, 4 / 3.0),
            Point.xyr(0.5, 1.0, 1.0),
            Point.xyr(1.0, 0.0, 0.0)
        )
            .reduce()
        ...
        val b5 = Bezier(
            Point.xyr(-1.0, 0.0, 0.0),
            Point.xyr(-0.6, 0.8, 0.8),
            Point.xyr(-0.3, 1.2, 1.2),
            Point.xyr(0.3, 1.2, 1.2),
            Point.xyr(0.6, 0.8, 0.8),
            Point.xyr(1.0, 0.0, 0.0)
        )
    ...
    fun testSubdivide() {
        ...
        assertThat(
            a0, `is`(
                closeTo(
                    Bezier(
                        Point.xyr(-2.0, 0.0, 1.0),
                        Point.xyr(-7 / 4.0, 0.0, 5 / 4.0),
                        Point.xyr(-3 / 2.0, 1 / 8.0, 21 / 16.0),
                        Point.xyr(-5 / 4.0, 9 / 32.0, 83 / 64.0),
                        Point.xyr(-1.0, 27 / 64.0, 161 / 128.0)
                    )
                )
            )
        ...
        assertThat(
            a1, `is`(
                closeTo(
                    Bezier(
                        Point.xyr(-1.0, 27 / 64.0, 322 / 256.0),
                        Point.xyr(-1 / 4.0, 27 / 32.0, 73 / 64.0),
                        Point.xyr(1 / 2.0, 9 / 8.0, 13 / 16.0),
                        Point.xyr(5 / 4.0, 0.0, 7 / 4.0),
                        Point.xyr(2.0, 0.0, 1.0)
                    )
                )
            )
    ...
    fun testExtend() {
        ...
        assertThat(
            extendBack, `is`(
                closeTo(
                    Bezier(
                        Point.xyr(-2.0, 0.0, 1.0),
                        Point.xyr(-1.0, 0.0, 8.0),
                        Point.xyr(0.0, 2.0, 60.0),
                        Point.xyr(1.0, 0.0, 434.0),
                        Point.xyr(2.0, 0.0, 3073.0)
                    )
                )
            )
        )
        ...
        assertThat(
            extendFront, `is`(
                closeTo(
                    Bezier(
                        Point.xyr(-2.0, 0.0, 721 / 81.0),
                        Point.xyr(-1.0, 0.0, 134 / 27.0),
                        Point.xyr(0.0, 2.0, 28 / 9.0),
                        Point.xyr(1.0, 0.0, 8 / 3.0),
                        Point.xyr(2.0, 0.0, 1.0)
                    )
                )
            )
