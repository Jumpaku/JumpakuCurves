...
class EllipticSnapper(override val pointSnapper: PointSnapper): ConicSectionSnapper {
    ...
    override fun snap(conicSection: ConicSection): Stream<ConicSectionSnapResult> {
        ...
        return features.flatMap { (f0, f1, f2) ->
            ...
            affine.map { ConicSectionSnapResult(Array.of(f0, f1, f2), snapped, it, conicSection.transform(it)) }
        }
    }
}