...
class PointSnapperTest {
    ...
    fun testSnap0() {
        ...
        assertThat(snapper.snap(Point.xr(0 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(1 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(2 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(3 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(4 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(5 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(6 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(7 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(8 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(9 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(10 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(11 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(12 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(13 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(14 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(15 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(16 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(17 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(18 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(19 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(20 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(21 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(22 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(23 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(24 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(25 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(26 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(27 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(28 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(29 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(30 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(31 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(32 / 32.0, r)).snappedGridPoint.isDefined).isFalse()
    }
    ...
    fun testSnap1() {
        ...
        assertThat(snapper.snap(Point.xr( 0/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 1/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr( 2/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr( 3/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr( 4/32.0, r)).snappedGridPoint.isDefined).isFalse()
        ...
        assertThat(snapper.snap(Point.xr( 6/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr( 7/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr( 8/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 9/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(10/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(10/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(12/32.0, r)).snappedGridPoint.isDefined).isFalse()
        ...
        assertThat(snapper.snap(Point.xr(14/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(15/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(16/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(17/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(18/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(19/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(20/32.0, r)).snappedGridPoint.isDefined).isFalse()
        ...
        assertThat(snapper.snap(Point.xr(22/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(23/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(24/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(25/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(26/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(27/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(28/32.0, r)).snappedGridPoint.isDefined).isFalse()
        ...
        assertThat(snapper.snap(Point.xr(30/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(31/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(32/32.0, r)).snappedGridPoint.isDefined).isTrue()
    }
    ...
    fun testSnap2() {
        ...
        assertThat(snapper.snap(Point.xr( 0/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 1/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 2/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr( 3/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr( 4/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr( 5/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr( 6/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr( 7/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 8/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 9/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(10/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(11/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(12/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(13/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(14/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(15/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(16/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(17/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(18/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(19/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(20/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(21/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(22/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(23/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(24/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(25/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(26/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(27/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(28/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(29/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(30/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(31/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(32/32.0, r)).snappedGridPoint.isDefined).isTrue()
    }
    ...
    fun testSnap3() {
        ...
        assertThat(snapper.snap(Point.xr( 0/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 1/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 2/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 3/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 4/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr( 5/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 6/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 7/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 8/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 9/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(10/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(10/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(12/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(13/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(14/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(15/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(16/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(17/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(18/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(19/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(20/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(21/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(22/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(23/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(24/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(25/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(26/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(27/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(28/32.0, r)).snappedGridPoint.isDefined).isFalse()
        assertThat(snapper.snap(Point.xr(29/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(30/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(31/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(32/32.0, r)).snappedGridPoint.isDefined).isTrue()
    }
    ...
    fun testSnap4() {
        ...
        assertThat(snapper.snap(Point.xr( 2/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 3/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 4/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 5/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 6/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 7/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr( 8/32.0, r)).snappedGridPoint.isDefined).isTrue()
        ...
        assertThat(snapper.snap(Point.xr(10/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(10/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(12/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(13/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(14/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(15/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(16/32.0, r)).snappedGridPoint.isDefined).isTrue()
        ...
        assertThat(snapper.snap(Point.xr(18/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(19/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(20/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(21/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(22/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(23/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(24/32.0, r)).snappedGridPoint.isDefined).isTrue()
        ...
        assertThat(snapper.snap(Point.xr(26/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(27/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(28/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(29/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(30/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(31/32.0, r)).snappedGridPoint.isDefined).isTrue()
        assertThat(snapper.snap(Point.xr(32/32.0, r)).snappedGridPoint.isDefined).isTrue()
