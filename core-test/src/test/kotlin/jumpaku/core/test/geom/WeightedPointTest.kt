...
class WeightedPointTest {
    ...
    fun testDivide() {
        ...
        p1.lerp(-1.0, p2).shouldEqualToWeightedPoint(WeightedPoint(Point.xr(16.0 / 4.0, 100.0 / 4.0), 4.0))
        p1.lerp(0.0, p2).shouldEqualToWeightedPoint(WeightedPoint(Point.xr(6.0 / 3.0, 30.0 / 3.0), 3.0))
        p1.lerp(0.4, p2).shouldEqualToWeightedPoint(WeightedPoint(Point.xr(2.0 / 2.6, 34.0 / 2.6), 2.6))
        p1.lerp(1.0, p2).shouldEqualToWeightedPoint(WeightedPoint(Point.xr(-4.0 / 2.0, 40.0 / 2.0), 2.0))
        p1.lerp(2.0, p2).shouldEqualToWeightedPoint(WeightedPoint(Point.xr(-14.0 / 1.0, 110.0 / 1.0), 1.0))
    }
