...
class BezierDerivativeTest {
    ...
    fun testProperties() {
        ...
        b4.controlVectors[0].shouldBeVector(Vector(1.0, -2.0, 0.0))
        b4.controlVectors[1].shouldBeVector(Vector(2.0, -1.0, 0.0))
        b4.controlVectors[2].shouldBeVector(Vector(0.0, 2.0))
        b4.controlVectors[3].shouldBeVector(Vector(2.0, 1.0, 0.0))
        b4.controlVectors[4].shouldBeVector(Vector(1.0, 2.0, 0.0))
        b4.controlVectors.size().shouldBe(5)
        b4.degree.shouldBe(4)
    ...
    fun testToString() {
        ...
        p.toString().parseJson().flatMap { BezierDerivative.fromJson(it) }.get().toBezier().shouldBeBezier(p.toBezier())
    }
    ...
    fun testEvaluate() {
        ...
        b4.evaluate(0.0).shouldBeVector(Vector(-2.0, 0.0))
        b4.evaluate(0.25).shouldBeVector(Vector(-1.0, 27 / 64.0))
        b4.evaluate(0.5).shouldBeVector(Vector(0.0, 0.75))
        b4.evaluate(0.75).shouldBeVector(Vector(1.0, 27 / 64.0))
        b4.evaluate(1.0).shouldBeVector(Vector(2.0, 0.0))
    }
    ...
    fun testDifferentiate() {
        ...
        b.differentiate(0.0).shouldBeVector(Vector(4.0, 0.0))
        b.differentiate(0.25).shouldBeVector(Vector(4.0, 2.25))
        b.differentiate(0.5).shouldBeVector(Vector(4.0, 0.0))
        b.differentiate(0.75).shouldBeVector(Vector(4.0, -2.25))
        b.differentiate(1.0).shouldBeVector(Vector(4.0, 0.0))
    ...
    fun testRestrict() {
        ...
        b.restrict(0.25, 0.5).toBezier().shouldBeBezier(Bezier(
                Point.xy(-1.0, 27 / 64.0), Point.xy(-3 / 4.0, 9 / 16.0), Point.xy(-1 / 2.0, 11 / 16.0), Point.xy(-1 / 4.0, 3 / 4.0), Point.xy(0.0, 3 / 4.0)))
        b.restrict(Interval(0.25, 0.5)).toBezier().shouldBeBezier(Bezier(
                Point.xy(-1.0, 27 / 64.0), Point.xy(-3 / 4.0, 9 / 16.0), Point.xy(-1 / 2.0, 11 / 16.0), Point.xy(-1 / 4.0, 3 / 4.0), Point.xy(0.0, 3 / 4.0)))
    }
    ...
    fun testReverse() {
        ...
        val r = BezierDerivative(Vector(-2.0, 0.0), Vector(-1.0, 0.0), Vector(0.0, 2.0), Vector(1.0, 0.0), Vector(2.0, 0.0))
                .reverse()
        r.toBezier().shouldBeBezier(Bezier(
    ...
    fun testElevate() {
        ...
        instance.toBezier().shouldBeBezier(expected)
    }
    ...
    fun testSubdivide() {
        ...
        val bs = BezierDerivative(Vector(1.0, -2.0, 0.0), Vector(2.0, -1.0, 0.0), Vector(0.0, 0.0, 2.0), Vector(2.0, 1.0, 0.0), Vector(1.0, 2.0, 0.0))
                .subdivide(0.25)
        bs._1().toBezier().shouldBeBezier(Bezier(
        ...
        bs._2().toBezier().shouldBeBezier(Bezier(
    ...
    fun testExtend() {
        ...
        val extendBack = BezierDerivative(
                ...
                .extend(4.0)
        extendBack.toBezier().shouldBeBezier(Bezier(
                Point.xy(-2.0, 0.0), Point.xy(-1.0, 0.0), Point.xy(0.0, 2.0), Point.xy(1.0, 0.0), Point.xy(2.0, 0.0)))
        ...
        val extendFront = BezierDerivative(
                ...
                .extend(-1/3.0)
        extendFront.toBezier().shouldBeBezier(Bezier(
                Point.xy(-2.0, 0.0), Point.xy(-1.0, 0.0), Point.xy(0.0, 2.0), Point.xy(1.0, 0.0), Point.xy(2.0, 0.0)))
    }
}