...
class AffineTest {
    ...
    fun testConcatenate() {
        ...
        val c = identity
                ...
                .invoke(Point.xyz(3.0, -2.0, -1.0))
        c.shouldBePoint(Point.xyz(0.0, 1.0, 3.0))
    }
    ...
    fun testTransformAt() {
        ...
        t.shouldBePoint(Point.xyz(1.0, 3.0, -0.5))
        ...
        s.shouldBePoint(Point.xyz(5.6, -15.2, 0.0))
    }
    ...
    fun testSimilarity() {
        ...
        s.shouldBePoint(Point.xyz(1.0, -1.0, 1.0))
    }
    ...
    fun testCalibrate() {
        ...
        c0.shouldBePoint(Point.xyz(1.0, -1.0, 1.0))
        val c1 = c.get().invoke(Point.xyz(0.0, 1.0, 0.0))
        c1.shouldBePoint(Point.xyz(1.0, 1.0, -1.0))
        val c2 = c.get().invoke(Point.xyz(0.0, 0.0, 1.0))
        c2.shouldBePoint(Point.xyz(-1.0, 1.0, 1.0))
        val c3 = c.get().invoke(Point.xyz(-1.0, -1.0, -1.0))
        c3.shouldBePoint(Point.xyz(1.0, 1.0, 1.0))
        val r0 = c.get().invoke(Point.xyz(0.0, 0.0, 0.0))
        r0.shouldBePoint(Point.xyz(0.5, 0.5, 0.5))
    }
    ...
    fun testCalibrateToPlane() {
        ...
        r0.shouldBePoint(Point.xyz(-1.0, 1.0, 1.0))
    }
