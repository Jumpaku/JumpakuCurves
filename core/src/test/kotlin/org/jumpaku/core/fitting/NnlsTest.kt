...
class NnlsTest {
    ...
    fun testNonNegativeLinearLeastSquareFitting() {
        ...
        val modelMatrix0 = createModelMatrix(data0.map(TimeSeriesPoint::time), 3, b0.knotVector)
    ...
    fun testNonNegativeLinearLeastSquareNonNegative() {
        ...
        val modelMatrix1 = createModelMatrix(data1.map(TimeSeriesPoint::time), 3, b1.knotVector)
